...
public class BD {
    ...
    private static final String SQL_CREATE_ODONTOLOGOS="DROP TABLE IF EXISTS ODONTOLOGOS; "+
            "CREATE TABLE ODONTOLOGOS(NUMERO_MATRICULA INT PRIMARY KEY, NOMBRE VARCHAR(100) NOT NULL, APELLIDO VARCHAR(100) NOT NULL)";
    ...
    private static final String SQL_INSERT_ODONTOLOGO_PRUEBA="INSERT INTO ODONTOLOGOS VALUES ( 12113, 'Juan', 'Perez' )";
...
public static void crearTablas(){
    ...
    try{
        ...
        statement.execute(SQL_INSERT_ODONTOLOGO_PRUEBA);
    ...
    return DriverManager.getConnection("jdbc:h2:~/ClinicaOdontologicaC3","sa","sa");
}
}
